# Configurador Simple - Todo en Uno
# Ejecutar como Administrador

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "    CONFIGURADOR AUTOMATICO" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not $isAdmin) {
    ...
    Write-Host "4. Confirma con 'Sí'" -ForegroundColor White
    Write-Host "5. Ejecuta este script de nuevo" -ForegroundColor White
    Read-Host "Presiona Enter"
    exit 1
}

Write-Host "Configurando sincronización automática..." -ForegroundColor Green
...
Write-Host "✅ Email configurado: facuslice@gmail.com" -ForegroundColor Green
Write-Host "✅ Base de datos se sincronizará automáticamente" -ForegroundColor Green
Write-Host ""
