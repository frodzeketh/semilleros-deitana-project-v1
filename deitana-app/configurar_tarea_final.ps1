...
try {
    ...
    Write-Host "2. Crear tarea: 'Sincronización ERP 2:00 AM'" -ForegroundColor White
    Write-Host "3. Programar: Diariamente a las 02:00 AM" -ForegroundColor White
    Write-Host "4. Acción: powershell.exe -ExecutionPolicy Bypass -File 'sync_erp_railway.ps1'" -ForegroundColor White
}
